...
const char* ssid = "STEATX"; //replace with your own wifi ssid 
const char* password = "steatx2018"; //replace with your own //wifi ssid password 
...
String url = "/test/postdemo(out).php";
 url += "?TempOut=";
url += 1.1;
url += "&TempIn=";
url += 2.2;
